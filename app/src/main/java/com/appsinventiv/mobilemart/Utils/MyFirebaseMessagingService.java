package com.appsinventiv.mobilemart.Utils;
...
import com.appsinventiv.mobilemart.Activities.HomePage;
import com.appsinventiv.mobilemart.Activities.MyAds;
...
//                handleNow(msg);
    ...
    private void handleNow(String notificationTitle, String messageBody) {
        ...
        if (type.equalsIgnoreCase("adActivated")) {
            ...
            resultIntent = new Intent(this, HomePage.class);
        }
